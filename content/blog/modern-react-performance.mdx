...
excerpt: "React is fast. Using it wrong isn't. INP replaced FID in March 2024, the React Compiler handles memoization automatically, and RSC payload size is the main network bottleneck most teams are ignoring. Here's how to find and fix each one."
tags:
  - React
  - Performance
  - Web Vitals
